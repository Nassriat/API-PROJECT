 ...
 * [SUPERHEROS](#SUPERHEROS)
    ...
    - [Exemples de requêtes SQL SUPERHEROS](#Exemples-de-requetes-SQL-SUPERHEROS)
 * [MARVEL](#MARVEL)
    ...
    - [Exemples de requêtes SQL MARVEL](#Exemples-de-requetes-SQL-MARVEL)
 * [PAYS](#PAYS)
    ...
    - [Exemples de requêtes SQL PAYS](#Exemples-de-requetes-SQL-PAYS)
...
1) **Combien de pays ont pour acronyme EU**
...
2) **Les pays qui ne sont pas dans Southern Asia**
...
3) **La population totale en Afrique**
